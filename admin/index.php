...
<head>
	...
	<link rel="stylesheet" href="../css/css.css?v10.0.3"/>
...
<body>
	<div class="navbar-topo1 hidden-print">
		<div class="container-fluid">
			...
			<div class="pull-right">
				<a href="./" class="btn btn-topo1 btn-xs">Pagina Inicial</a>
			</div>
		</div>
	</div>
	<div class="navbar-topo2 hidden-print">
		<div class="container-fluid">
	...
	<div class="navbar-topo3 hidden-print">
		<div class="container-fluid">
				...
				<ul class="nav navbar-nav botoes-topo3">
				   <li class="dropdown">
						...
						<ul class="dropdown-menu">
							<?php if($financeiro_array == $_SESSION['id_usuario_logado']) { ?>
							<li role="presentation" class="dropdown-header">CADASTRO </li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('financeiro/cadastro-nota.php','.conteudo')">NOTA FISCAL</a></li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('financeiro/cadastro-empresa-2.php','.conteudo')">FORNECEDORES</a></li>
							...
							<li role="presentation" class="dropdown-header">CONSULTA </li>
								...
								<li class="sub-dropdown"><a href="#" onclick="ldy('financeiro/consulta-empresa.php','.conteudo')">LISTA DE FORNECEDORES</a></li>
							<li role="presentation" class="divider"></li>
					...
					<li><a href="#" onclick="ldy('financeiro/relatorio-extrato.php','.conteudo')">Saldo e Extratos</a></li>
					<li><a href="#" onclick="ldy('financeiro/relatorio-contas.php','.conteudo')">Contas a pagar</a></li>
					
					<li><a href="#" onclick="ldy('financeiro/cadastro-transferencia.php','.conteudo')">Transferencias</a></li>

					<li class="dropdown">         
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-search"></span> Gerenciador SS <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<?php if($gerenciadorss_array == $_SESSION['id_usuario_logado']) { ?>
						<li role="presentation" class="dropdown-header">SS</li>
							<li class="sub-dropdown"><a href="#" onclick="ldy('ss/inicio.php','.conteudo')">GERENCIAR SS</a></li>
							<li class="sub-dropdown"><a href="#" onclick="ldy('ss/cadastro-protocolo.php','.conteudo')">PROTOCOLO</a></li>
					<?php if($editarss_usuario == '1' ){ ?>
						<li role="presentation" class="divider"></li>
						<li role="presentation" class="dropdown-header">CONSULTA</li>    
							<li class="sub-dropdown"><a href="#" onclick="ldy('ss/consulta-ss-medicao.php','.conteudo')">VALORAR SS</a></li>
							<li class="sub-dropdown"><a href="#" onclick="ldy('ss/consulta-ss-editar.php','.conteudo')">EDITAR MEDIÇÃO</a></li>
					<?php } ?>
					<?php } ?>
						</ul>
					</li>
					<li class="dropdown">         
						...
						<ul class="dropdown-menu">
							<?php if ($gestor_array == $_SESSION['id_usuario_logado']) { ?>
							<li role="presentation" class="dropdown-header">RH</li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('gestor/consulta-usuarios.php','.conteudo')">USUARIOS</a></li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('gestor/consulta-equipes.php','.conteudo')">CONTAS</a></li>
							<li role="presentation" class="divider"></li>
							<li role="presentation" class="dropdown-header">SS</li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('gestor/consulta-situacoes.php','.conteudo')">SITUAÇÕES</a></li>  	
							<li role="presentation" class="divider"></li>
							<li role="presentation" class="dropdown-header">ALMOXARIFADO</li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('almoxarifado/consulta-materiais-polemica.php','.conteudo')">ITEM MATERIAL</a></li>
								<li class="sub-dropdown"><a href="#" onclick="ldy('gestor/consulta-categoria-polemica.php','.conteudo')">CATEGORIAS</a></li>
							<?php } ?>
						</ul>
					</li>
					<li style="opacity:0.6"><a href="#">Botão 4</a></li>
					<li style="opacity:0.6"><a href="#">Botão 5</a></li>
					<li style="opacity:0.6"><a href="#">Botão 6</a></li>
					<li style="opacity:0.6"><a href="#">Botão 7</a></li>
					<li style="opacity:0.6"><a href="#">Botão 8</a></li>
					<li style="opacity:0.6"><a href="#">Botão 9</a></li>
					<li style="opacity:0.6"><a href="#">Botão 10</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container" style="padding:0px">
		<div class="navbar-footer">
			<div class="container-fluid">
				<span>&nbsp;&nbsp; Copyright &copy; 2019 <strong>Atlasware | Soluções tecnologicas.</strong> Todos direitos reservados. </span>
			</div>
		</div>
	</div>

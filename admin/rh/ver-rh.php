...
<div class="hidden-print">
	...
	while($l=mysql_fetch_array($sql)) { 
		extract($l); 
	?>
	<form action="javascript:void(0)" class="small formulario-info" enctype="multipart/form-data" style="font-size:11px">
				...
				<div class="col-md-2">
					...
					<div class="col-md-12" style="padding:0px; text-align:center">
						<div class="col-md-6" style="padding:3px;  text-align:center">
							<input type="radio" name="tipo_emp" value="0" style="height: 19px; width: 19px;" checked disabled>
							<small style="font-size:15px; position:relative; bottom:3px; font-weight:bold; font-family: 'Oswald', sans-serif;">Funcionário</small>
						</div>
						<div class="col-md-6" style="padding:3px; text-align:center">
							<input type="radio" name="tipo_emp" value="1" style="margin-left:10px; height: 19px; width: 19px;" disabled>
				...
				<div class="col-md-10">
					<div class="col-md-8" style="padding:3px">
						<label style="width:100%">
							Nome Completo: 
							<input type="text" name="nome" value="<?php echo $nome ?>" class="form-control input-sm" required  disabled />
						</label>
					</div>
					<div class="col-md-2" style="padding:3px">
						<label style="width:100%">
							N° Ordem: 
							<input type="text" name="numero_ordem" value="<?php echo $numero_ordem ?>" class="form-control input-sm"  disabled />
						</label>
					</div>
					<div class="col-md-2" style="padding:3px">
						<label style="width:100%">
							N° Matrícula:
							<input type="text" name="numero_matricula" value="<?php echo $numero_matricula ?>" class="form-control input-sm"  disabled />
						</label>
					</div>
					<div class="col-md-4" style="padding:3px">
						<label style="width:100%">Situação: <br/>
							<select class="form-control input-sm" name="situacao" onChange="$('.item-situ').load('rh/editar-funcionario.php?situ_tipo=demi&situacao=' + $(this).val() + '');" disabled>
								<?php 
									$situacoes = mysql_query("select * from rh_situacao where status = '0' AND id <> '0' order by descricao asc"); while($l=mysql_fetch_array($situacoes)) {
										$descricao = explode("_", $l['descricao']);
										if($situacao==$l['id']){ 
											echo '<option value="'.$l['id'].'" style="color:#EC971F" selected>'.$descricao[1].' *** </option>'; 
										} else { 
											echo '<option value="'.$l['id'].'">'.$descricao[1].'</option>';
										}  
									} 
								?>	
							</select>
					...
					<div class="col-md-4" style="padding:3px">
						<label style="width:100%">Obra/Contrato:
							<select class="form-control input-sm" name="obra" style="width:100%" onChange="$('#itens-rh').load('rh/editar-funcionario.php?city=ok&obra_2=' + $(this).val() + '');" disabled>
							<?php 
					...
					<div class="col-md-4" style="padding:3px">
						<label id="itens-rh" style="width:100%">
							<label style="width:100%">Equipe: <br/>
								<select name="equipe" class="form-control input-sm" style="width:100%" disabled>
									...
									$sss = mysql_query("select * from equipes WHERE id = '$equipe'"); 
					...
					<div class="col-md-6" style="padding:0px;">
						<div class="col-md-9" style="padding:3px">
							<label style="width:100%">
								Pai: <input type="text" name="nome_pai" value="<?php echo $nome_pai ?>" class="form-control input-sm" size="30"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Nacionalidade: <input type="text" name="nacionalidade_pai" value="<?php echo $nacionalidade_pai ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-9" style="padding:3px">
							<label style="width:100%">
								Mãe: <input type="text" name="nome_mae" value="<?php echo $nome_mae ?>" class="form-control input-sm up"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Nacionalidade: <input type="text" name="nacionalidade_mae" value="<?php echo $nacionalidade_mae ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">Casado:
								<select name="casado_brasileira" onChange="$('#itens-casado').load('rh/editar-funcionario.php?casado=ok&nome_conjuge=<?php echo $nome_conjuge; ?>&casado_brasileira=' + $(this).val() + '');" class="form-control input-sm" disabled>
									<?php 
							...
							<label id="itens-casado" style="width:100%">
								<?php
									if($casado_brasileira == 'SIM'){
										echo '
												Nome do conjuge: 
												<input type="text" name="nome_conjuge" value="'.$nome_conjuge.'" class="form-control input-sm" required disabled />
														';
									}else{
										echo '
												Nome do conjuge: 
												<input type="text" name="nome_conjuge" value="&nbsp;" class="form-control input-sm" disabled disabled />
														';
									}
								?>
							</label>
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">Filhos Brasileiros?
								<select name="tem_filhos_brasileiros" class="form-control input-sm"  disabled>
									<?php 
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">Quantos filhos:
								<select name="quantidade_filhos" class="form-control input-sm" disabled>
									<?php 
										for($fil = 0; $fil<=6; $fil++){
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Residencial:
								<input type="text" name="telefone" value="<?php echo $telefone ?>" class="form-control input-sm" placeholder="(__)____-____" onFocus="$(this).mask('(99)9999-9999')"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Celular:
								<input type="text" name="celular" value="<?php echo $celular ?>" class="form-control input-sm" placeholder="(__)_____-____" onFocus="$(this).mask('(99)99999-999?9')"  disabled />
							</label>
						</div>
					</div>
					<div class="col-md-6" style="padding:0px;">
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Data Nascimento: 
								<input type="date" name="nascimento" value="<?php echo $nascimento ?>" class="form-control input-sm" disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Local nascimento:
								<input type="text" name="local_nascimento" value="<?php echo $local_nascimento ?>" class="form-control input-sm" disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Nacionalidade: 
								<input type="text" name="nacionalidade" value="<?php echo $nacionalidade ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%"> 
								Estado Civíl: 
								<select class="form-control input-sm" name="estado_civil" value="<?php echo $estado_civil ?>" disabled>
									<?php 
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Estado: <input type="text" name="estado" value="<?php echo $estado ?>" class="form-control input-sm" disabled />
							</label>	
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Identidade (RG): <input type="text" name="rg" placeholder="__.___.___-_" value="<?php echo $rg ?>" class="form-control input-sm"  disabled />
							</label>	
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								CPF:<input type="text" name="cpf" onFocus="$(this).mask('999.999.999-99')" value="<?php echo $cpf ?>" class="form-control input-sm" disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								C. Profissional: <input type="text" name="carteira_profissional" value="<?php echo $carteira_profissional ?>" class="form-control input-sm"  disabled />
							</label>	
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Série:<input type="text" name="serie" value="<?php echo $serie ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Reservista: <input type="text" name="carteira_reservista" value="<?php echo $carteira_reservista ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Categoria: <input type="text" name="carteira_reservista_categoria" value="<?php echo $carteira_reservista_categoria ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Titulo de Eleitor:<input type="text" name="titulo_eleitor" onFocus="$(this).mask('999999999?9999')" value="<?php echo $titulo_eleitor ?>" class="form-control input-sm" maxlength="13"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Carteira de Saúde:<input type="text" name="carteira_saude" value="<?php echo $carteira_saude ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">Naturalizado?
								<select name="naturalizado" class="form-control input-sm" disabled>
									<?php 
										if($naturalizado == "SIM"){
											echo '<option value="SIM" selected>SIM</option>';
											echo '<option value="NÃO">NÃO</option>';
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">Grau de instrução: 
								<select class="form-control input-sm" name="grau_instrucao" disabled>
								<?php 
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Cidade de serviço: 
								<select name="cidade_servico" class="form-control input-sm" disabled>
									<?php 
					...
					<div class="col-md-12" style="padding:0px;">
						<label style="width:100%">
							Endereço Completo: <input type="text" name="endereco" value="<?php echo $endereco ?>" class="form-control input-sm" disabled />
						</label>
					</div>
					<div class="col-md-12" style="padding:0px;">
						<label style="width:100%">Obs:
							<textarea name="adm_obs" class="form-control input-sm" style="resize:none; text-align:left" disabled><?php echo $adm_obs; ?></textarea>
						</label>
					</div>
				</div>
			</div>
					...
					<div class="panel-body">
						...
						<div class="col-md-6" style="padding:3px;">
							<label style="width:100%">Cargo: <br/>
								<select class="form-control input-sm" name="funcao" disabled>
									<option value="0"></option>
										<?php 
											$funcoes = mysql_query("select * from rh_funcoes where id = '$funcao'");
											while($l=mysql_fetch_array($funcoes)) {
												echo '<option selected>'.$l['descricao'].'</option>'; 	
											} 
										?>	
								</select>
							</label>
						...
						<div class="col-md-2" style="padding:3px;">
							<label style="width:100%">Experiência:<br/>
								<select class="form-control input-sm" name="exp" disabled>
								<?php  
								if($exp==0){
						...
						<div class="col-md-2" style="padding:3px;">						
							<label style="width:100%">Dias da Experiência: <br/>
								<select class="form-control input-sm" name="expdias" disabled>
									<?php 
									if($expdias == '1'){
										echo '
						...
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">Comissões: 
								<input type="number" step="0.1" name="comissoes" class="form-control input-sm" value="<?php echo $comissoes ?>"  disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">Tarefa: 
								<input type="text" name="tarefa" class="form-control input-sm" value="<?php echo $tarefa ?>"  disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">F. Pagamento: 
								<input type="text" name="forma_pagamento" class="form-control input-sm"  size="10" value="<?php echo $forma_pagamento ?>"  disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">CNH: 
								<input type="text" name="cnh" class="form-control input-sm"  size="15" value="<?php echo $cnh ?>"  disabled />
							</label>	
						</div>
						<div class="col-md-2" style="padding:3px;">		
							<label style="width:100%">Venc CNH: 
								<input type="date" name="venc_cnh" class="form-control input-sm"  size="15" value="<?php echo $venc_cnh ?>"  disabled />
							</label>	
						</div>
						<div class="col-md-2" style="padding:3px;">		
							<label style="width:100%">Categoria CNH:
								<input type="text" name="categoria_cnh" class="form-control input-sm"  size="5" value="<?php echo $categoria_cnh ?>" disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">Admissão: 
								<input type="date" name="admissao" class="form-control input-sm" value="<?php echo $admissao ?>" required  disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">Registro: 
								<input type="date" name="data_registro" class="form-control input-sm" value="<?php echo $data_registro ?>" required  disabled />
							</label>
						</div>
						<div class="item-situ">
							<div class="col-md-2" style="padding:3px;">	
								<label style="width:100%">Demissão: 
									<?php 
									if($situacao == 1){
										echo '<input type="date" name="demissao" class="form-control input-sm" value="'.$demissao.'" required disabled />';
									}else{
						...
						<div class="col-md-2" style="padding:3px;">	
							<label style="width:100%">Administrativo:
								<select name="adm" class="form-control input-sm" disabled>
									<?php 
										if($adm == '1'){
											echo '<option value="0">NÃO</option>';
											echo '<option value="1" selected>SIM</option>';
						...
						<div class="col-md-6" style="padding:0px;">
							<div class="col-md-12" style="padding:3px;">
								<label style="width:100%">Vale Trans.:?
									<select name="vale_transporte" class="form-control input-sm" disabled>
										<?php 
							...
							<div class="vale-situ">
								<div class="col-md-12" style="padding:3px;">
									<label style="width:100%">Valor 1:
										...
										<input type="number" step="0.01" name="vale_qtd" class="form-control input-sm"  value="<?php echo $vale_qtd ?>"  disabled />
									</label>
								</div>
								<div class="col-md-12" style="padding:3px;">
									<label style="width:100%">Valor 2:
										<!--<input type="hidden" name="vale_empresa2" value="'.$t['nome'].'">-->
										<input type="number" step="0.01" name="vale_qtd2" class="form-control input-sm"  value="<?php echo $vale_qtd2 ?>"  disabled />
									</label>
								</div>
							</div>
						</div>
						<div class="col-md-6" style="padding:0px;">
							<div class="col-md-12" style="padding:3px;">
								<label style="width:100%">Alimentação (Mensal): 
									<input type="number" step="any" name="vale_alimentacao" class="form-control input-sm"  value="<?php echo $vale_alimentacao ?>"  disabled />
								</label>
							</div>		
							<div class="col-md-12" style="padding:3px;">							
								<label style="width:100%">Refeição (Diario): 
									<input type="number" step="any" name="vale_refeicao" class="form-control input-sm" value="<?php echo $vale_refeicao ?>"  disabled />
								</label>
							</div>
						</div>
					</div>	
			...
			<div class="col-md-7">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="col-md-2" style="padding:3px">
							<label style="width:100%">
								Cadastrado em: <input type="date" name="pis_cadastro" value="<?php echo $pis_cadastro ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-2" style="padding:3px">
							<label style="width:100%">
								Numero PIS: <input type="text" name="pis_numero" value="<?php echo $pis_numero ?>" class="form-control input-sm"  disabled />
							</label>	
						</div>
						<div class="col-md-1" style="padding:3px">
							<label style="width:100%">
								Banco: <input type="text" name="pis_banco" value="<?php echo $pis_banco ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-5" style="padding:3px">
							<label style="width:100%">
								Endereço: <input type="text" name="pis_endereco" value="<?php echo $pis_endereco ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-1" style="padding:3px">
							<label style="width:100%">
								Banco: <input type="text" name="pis_numbanco" value="<?php echo $pis_numbanco ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-1" style="padding:3px">
							<label style="width:100%">
								Agência: <input type="text" name="pis_agencia" value="<?php echo $pis_agencia ?>" class="form-control input-sm"  disabled />
							</label>		
						</div>
					</div>
				</div>	
					...
					<div class="panel-body">
						<div class="col-md-2" style="padding:3px">
							<label style="width:100%">Optante:
								<select name="optante_fgts" class="form-control input-sm" disabled>
								<?php 
									if($optante_fgts == "SIM"){
										echo '<option value="SIM" selected>SIM</option>';
										echo '<option value="NÃO">NÃO</option>';
						...
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Data Opção: <input type="date" name="data_opcao_fgts" value="<?php echo $data_opcao_fgts ?>" class="form-control input-sm"  disabled />
							</label>	
						</div>
						<div class="col-md-3" style="padding:3px">
							<label style="width:100%">
								Retratação: <input type="date" name="data_retratacao_fgts" value="<?php echo $data_retratacao_fgts ?>" class="form-control input-sm"  disabled />
							</label>
						</div>
						<div class="col-md-4" style="padding:3px">
							<label style="width:100%">Banco Depositário: 
								<input type="text" name="banco_depositario" value="<?php echo $banco_depositario ?>" class="form-control input-sm" disabled />
							</label>	
						</div>
					</div>
				</div>	
						...
						<div class="col-md-10" style="padding:0px;">
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Periodo: 
									<select name="trabalho_periodo" class="form-control input-sm" disabled>
										<?php 
							...
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Entrada: 
									<input type="text" class="form-control input-sm" name="trabalho_entrada" onfocus="$(this).mask('99:99')" value="<?php echo $trabalho_entrada ?>" disabled />
								</label>
							</div>
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Descanso/Almoço: 
									<input type="text" class="form-control input-sm" name="trabalho_refeicao" onfocus="$(this).mask('99:99 - 99:99')" value="<?php echo $trabalho_refeicao ?>" disabled />
								</label>
							</div>
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Saída: 
									<input type="text" class="form-control input-sm" name="trabalho_saida" onfocus="$(this).mask('99:99')" value="<?php echo $trabalho_saida ?>" disabled />
								</label>
							</div>
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Periodo Extra: 
									<select name="trabalho_periodo2" class="form-control input-sm" disabled>
									<?php 
							...
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Entrada: 
									<input type="text" class="form-control input-sm" name="trabalho_entrada2" onfocus="$(this).mask('99:99')" value="<?php echo $trabalho_entrada2 ?>" disabled />
								</label>
							</div>
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Descanso/Almoço: 
									<input type="text" class="form-control input-sm" name="trabalho_refeicao2" onfocus="$(this).mask('99:99 - 99:99')" value="<?php echo $trabalho_refeicao2 ?>" disabled />
								</label>
							</div>
							<div class="col-md-3" style="padding: 3px;">
								<label style="width:100%">Saída: 
									<input type="text" class="form-control input-sm" name="trabalho_saida2" onfocus="$(this).mask('99:99')" value="<?php echo $trabalho_saida2 ?>" disabled />
								</label>
							</div>
						</div>
						<div class="col-md-2" style="padding:3px;">
							<label style="width:100%;">Descanso:
								<input type="text" class="form-control input-sm" name="trabalho_descanso" value="<?php echo $trabalho_descanso ?>" disabled />
							</label>
						</div>
					</div>
				</div>
		...
		<center style="margin-bottom:40px;  border-radius:5px;">
			<button type="submit" class="btn btn-success btn-sm" style="width:50%; height:50px; font-size:13px;" disabled><span class="glyphicon glyphicon-floppy-disk"></span> Salvar Informações</button>
		</center>
	</form>
<?php } ?>
	<!-- LISTA HISTORICO -->
			...
			<form class="form-inline formulario-success" action="rh/upload-curso.php?funcionario=<?php echo $id ?>" target="_blank" enctype="multipart/form-data" method="POST">
				...
				<div class="col-md-6" style="padding: 3px">
					<label style="width:100%">
						...
						<select class="form-control input-sm combobox" name="curso" disabled>
							<?php 

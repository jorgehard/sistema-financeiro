...
<?php
      ...
      //frentes
      $frentes = mysql_query("select * from frentes order by ordem asc");
      ...
      //metas
      $metas = mysql_query("select * from metas");
      while($l = mysql_fetch_array($metas)) { $id_frente = $l['id'];
      $query = mysql_query("select *, SUM(quantidade) as total_quantidade, SUM(valor) as total_valor from producao, equipes where equipes.id = producao.equipe and equipes.categoria = $id_frente and producao.frente = $id_frentes and data between '$inicial_en' and '$final_en' group by equipe order by equipes.nome asc");
      ...
      $_valor = 0;
         ...
         echo '<table class="table table-condensed" cellpadding="1">
         <tr class="small">
             <th>EQUIPE</th>
         ...
         echo '<tr class="small" style="font-size:9px;">';
...
<?php
      ...
      echo '<table class="table table-condensed"><tr class="small">';
      echo '<td colspan="4" width="430px" align="right">TOTAL FRENTE</td>';
      ...
      echo '<td width="80px" align="center">R$ '.number_format($_valortotal,"2",",",".").'</td>';
      echo '<td width="80px" align="center">R$ '.number_format($total_m,"2",",",".").'</td>';
      echo '<td width="120px" align="center">R$ '.number_format($total_s,"2",",",".").'</td>';
      echo '</tr></table>';
      ...
      echo '<td colspan="4" width="430px" align="right">TOTAL GERAL</td>';
      //$_valortotal = number_format(mysql_result(mysql_query("select *, SUM(valor) as total_valor from producao, equipes where equipes.id = producao.equipe and data between '$inicial_en' and '$final_en'"),0,"total_valor"),"2",",",".");
      echo '<td width="80px" align="center">R$ '.number_format($tv,"2",",",".").'</td>';
      echo '<td width="80px" align="center">R$ '.number_format($tm,"2",",",".").'</td>';
      echo '<td width="120px" align="center">R$ '.number_format($ts,"2",",",".").'</td>';
      echo '</tr></table>';

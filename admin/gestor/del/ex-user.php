<?php include("../../config.php");
	...
	$equipamento = mysql_query("SELECT * FROM usuarios WHERE id = '$id'") or die (mysql_error());
	...
	echo '
		<center>
			<div class="alert alert-danger" style="font-size:12px">
				Tem certeza que deseja excluir este usuario <strong>'.$nome.'</strong> permanentemente?
			</div>
		</center>';
	echo '
		<div class="ajax">
			<center>
			<a href="javascript:void(0)" class="btn btn-success btn-sm" style="width:150px; margin-right:20px;" onclick=\'ldy("gestor/del/ex-user.php?ac=excluir&id='.$id.'",".ajax")\'>Sim</a>

		<table class="table table-condensed table-bordered table-color">
			...
			<h4>
				<small style="font-family: \'Oswald\', sans-serif; letter-spacing:3px;">Selecionar itens para incluir a nota fiscal</small>
			</h4>
				...
				<table class="table table-condensed table-bordered table-blue small">
					...
					<tbody>
						<tr>
							...
							<td width="10%">
								<label style="width:100%">
									<input type="number" step="0.001" name="desconto" placeholder="R$" class="form-control input-sm" />
								</label>
							</td>
							<td width="10%">
								<label style="width:100%">
			...
			<?php
				echo '<script>ldy("financeiro/itens-nota-lista.php?id='.$id.'&obra_nt='.$obra_nt.'",".lista_itens"); </script>'; 
			?>

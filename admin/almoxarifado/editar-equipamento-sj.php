...
<?php
if(@$ac == 'up') {
	$query = mysql_query("UPDATE notas_equipamentos SET empresa = '$empresa', local = '$local', equipe = '$equipe', status_2 = '$status_2' WHERE id = $id");
	if($query) { 
		echo '<p class="text-success">Informações atualizadas</p>';
		echo '<script>$(".retorno").load("almoxarifado/editar-equipamento-sj.php?id='.$id.'")</script>'; 
	}else { 
...
<div class="ajax"></div>
	...
	<div class="col-xs-12" style="padding:0px">
		<form action="javascript:void(0)" onSubmit="post(this,'almoxarifado/editar-equipamento-sj.php?ac=up&id=<?php echo $id ?>','.ajax')" enctype="multipart/form-data" class="formulario-info">
			<div class="panel panel-info">
				...
				<div class="panel-body" style="width:100%">	
					<div class="col-xs-12 col-sm-4">
						...
						<div class="col-xs-6">
							<label style="width:100%">Patrimonio: <br/><input type="text" name="patrimonio" value="<?php echo $patrimonio; ?>" class="form-control input-sm up"  required  disabled ></label>
						</div>
						<div class="col-xs-6">
						...
						<div class="col-xs-6">
							<label style="width:100%">Desconto: <br><input type="text" name="desconto" value="<?php echo $desconto; ?>" class="form-control input-sm"  required disabled ></label>
						</div>
						<div class="col-xs-6">
					...
					<div class="col-xs-12 col-sm-4">
						...
						<div class="col-xs-12">
							<label for "" style="width:100%"> Categoria & Sub-Categoria: 
								<select name="categoria" onChange="$('#itens23').load('almoxarifado/sub-cat-eq.php?categoria=' + $(this).val() + '');" style="width:100%" class="form-control input-sm" id="categ" disabled >
						...
						<div class="col-xs-12">
							<label>Observações: <br><input type="text" maxlength="300" style="height: 100px;" size="300" name="obs" value="<?php echo $obs; ?>" class="form-control input-sm" disabled ></textarea></label>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<div class="col-xs-6">
							<label>Obra:
								<select name="obra_opcao" class="form-control dropdown input-sm" disabled >
									<?php
										$obras = mysql_query("select * from notas_obras WHERE id IN($obra_usuario) ORDER BY descricao");
						...
						<div class="col-xs-12">
							<label style="width:100%">Responsável: <br>
								<select name="local" class="form-control input-sm combobox">
						...
						<div class="col-xs-6">
							<label style="width:100%">Status: 
								<select class="form-control input-sm" name="status_2">
									<option value=""></option>
									<?php 

...
if($_FILES["myfile"]["name"]) {
	...
	mysql_query("update notas_equipamentos set `imagem` = '$fil' where id = '$id'");
	echo '<script>window.top.window.ldy("almoxarifado/editar-equipamento.php?id='.$id.'",".retorno")</script>';
?>
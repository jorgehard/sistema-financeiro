<?php include("../../config.php");
	...
	if(@$ac=='excluir') { 
		$query = mysql_query("delete from ss_materiais where id = '$id'"); 
		if($query) { 
	...
	$equipamento = mysql_query("SELECT * FROM ss_materiais WHERE id = '$id'") or die (mysql_error());
	...
	echo '
		<center>
			<div class="alert alert-danger" style="font-size:12px">
				Tem certeza que deseja excluir o material <strong>'.$descricao.'</strong> permanentemente?
			</div>
		</center>';
	echo '
		<div class="ajax">
			<center>
			<a href="javascript:void(0)" class="btn btn-success btn-sm" style="width:150px; margin-right:20px;" onclick=\'ldy("almoxarifado/del/excluir-mat-sabesp.php?ac=excluir&id='.$id.'",".ajax")\'>Sim</a>

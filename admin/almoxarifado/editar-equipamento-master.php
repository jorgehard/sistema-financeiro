...
if(@$ac == 'up') {
	$query = mysql_query("UPDATE notas_equipamentos SET obs = '$obs', obra = '$obra_opcao', local = '$local',equipe = '$equipe', placa = '$placa',patrimonio = '$patrimonio', marca = '$marca', patrimonio2 = '$patrimonio2', valor = '$valor', justificativa = '$justificativa', desconto = '$desconto', patrimonio2 = '$patrimonio2', dia_pagamento = '$dia_pagamento', chassi = '$chassi', ano = '$ano',empresa = '$empresa', categoria = '$categoria', sub_categoria = '$sub_categoria', status_2 = '$status_2', situacao = '$situacao', placa = '$placa', contrato = '$contrato', entrada = '$entrada', saida = '$saida', user_edit = '$id_usuario_logado', data_edit = now() WHERE id = $id");
			...
			<div class="panel panel-info">
				...
				<div class="panel-body" style="width:100%">	
					<div class="col-xs-12 col-sm-4">
						...
						<div class="col-xs-6">
							<label style="width:100%">Justificativa: <br><input type="text" name="justificativa" value="<?php echo $justificativa; ?>" class="form-control input-sm"  required /></label>
						</div>

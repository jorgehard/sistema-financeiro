...
(function ($) {
    ...
    MultipleSelect.prototype = {
        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                var value = $elm.val(),
                    ...
                    selected = (that.$el.attr('multiple') != undefined) ? $elm.prop('selecionado') : ($elm.attr('selecionado') == 'selecionado'),
        ...
        update: function (isInit) {
            ...
            this.$drop.find('li').removeClass('selecionado');
            this.$drop.find('input[' + this.selectItemName + ']:checked').each(function () {
                $(this).parents('li').first().addClass('selecionado');
            });
    ...
    $.fn.multipleSelect.defaults = {
        ...
        countSelected: '# of % selecionados',
        noMatchesFound: 'Nada Encontrado',
        multiple: false,
        multipleWidth: 80,
        single: false,
        filter: false,

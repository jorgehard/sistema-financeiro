...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" style="width:100%;" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando _START_ de _TOTAL_ resultados",
			 ...
			 *    } );
			 */
			"sSearch": "<i class=\"hidden-print fa-bg-t fa fa-search\" aria-hidden=\"true\"></i>",
	...
	$.extend( DataTable.ext.classes, {
		...
		/* Paging buttons */
		"sPageButton": "hidden-print paginate_button",
		"sPageButtonActive": "hidden-print current",
		"sPageButtonDisabled": "hidden-print disabled",
		...
		/* Filtering */
		"sFilterInput": "hidden-print",
	
		/* Page length */
		"sLengthSelect": "hidden-print",
